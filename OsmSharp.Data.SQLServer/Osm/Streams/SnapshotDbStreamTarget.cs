...
namespace OsmSharp.Data.SQLServer.Osm.Streams
{
    ...
    public class SnapshotDbStreamTarget : OsmStreamTarget
    {
        ...
        /// Creates a snapshot db target.
        /// </summary>
        public SnapshotDbStreamTarget(string connectionString, bool createSchema)
        {
            _connectionString = connectionString;
        ...
        /// Creates a snapshot db target.
        /// </summary>
        public SnapshotDbStreamTarget(SqlConnection connection)
        {
        ...
        /// Creates a snapshot db target.
        /// </summary>
        public SnapshotDbStreamTarget(SqlConnection connection, bool createSchema)
        {
            _connection = connection;
            _createAndDetectSchema = createSchema;
        }
        ...
        public override void Initialize()
        {
            ...
            { // create or detect the tables.
                SchemaTools.SchemaTools.SnapshotDbCreateAndDetect(_connection);
            }
        ...
        private void BulkCopy(DataTable table, string tableName, int batchSize)
        {
            ...
            using (var bulkCopy = new SqlBulkCopy(_connection))
            {
                ...
                try
                {
                    OsmSharp.Logging.Log.TraceEvent("SnapshotDbStreamTarget", 
        ...
        public override void Close()
        {
            if(_connection != null)
            {
                if(_createAndDetectSchema)
                {
                    SchemaTools.SchemaTools.SnapshotDbAddConstraints(_connection);
                }
